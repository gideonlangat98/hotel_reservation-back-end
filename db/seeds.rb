...
review4 = CustomerReview.create(comment: "The most beautiful guest house with the most lovely, warm and welcoming hosts", hotel_id: serena.id)
review5 = CustomerReview.create(comment: "Really good breakfast, cozy rooms, good beds and very nice and helpful owners", hotel_id: west.id)
